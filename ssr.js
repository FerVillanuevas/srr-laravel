...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./pages/${name}.tsx`, /* @__PURE__ */ Object.assign({ "./pages/auth/confirm-password.tsx": () => import("./assets/confirm-password-G8rU-P06.js"), "./pages/auth/forgot-password.tsx": () => import("./assets/forgot-password-Bm_VS9pf.js"), "./pages/auth/login.tsx": () => import("./assets/login-CLQCnSox.js"), "./pages/auth/register.tsx": () => import("./assets/register-C_guXizf.js"), "./pages/auth/reset-password.tsx": () => import("./assets/reset-password-uqjsfg_p.js"), "./pages/auth/verify-email.tsx": () => import("./assets/verify-email-BdQbCV_K.js"), "./pages/dashboard.tsx": () => import("./assets/dashboard--J2rz__M.js"), "./pages/demo.tsx": () => import("./assets/demo-Cv3X01AZ.js"), "./pages/settings/appearance.tsx": () => import("./assets/appearance-DJ0Mur_B.js"), "./pages/settings/password.tsx": () => import("./assets/password-B9gDFjtJ.js"), "./pages/settings/profile.tsx": () => import("./assets/profile-BS_vNEBg.js"), "./pages/welcome.tsx": () => import("./assets/welcome-DMPfod-z.js") })),
    setup: ({ App, props }) => {
